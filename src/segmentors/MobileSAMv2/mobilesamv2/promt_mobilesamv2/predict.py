import torch
from segmentors.MobileSAMv2.ultralytics.yolo.engine.results import Results
from segmentors.MobileSAMv2.ultralytics.yolo.utils import DEFAULT_CFG, ops
from segmentors.MobileSAMv2.ultralytics.yolo.v8.detect.predict import DetectionPredictor
