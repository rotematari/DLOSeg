...
from segmentors.MobileSAMv2.ultralytics import yolo  # noqa
from segmentors.MobileSAMv2.ultralytics.nn.tasks import (ClassificationModel, DetectionModel, PoseModel, SegmentationModel,
                                  attempt_load_one_weight, guess_model_task, nn, yaml_model_load)
from segmentors.MobileSAMv2.ultralytics.yolo.cfg import get_cfg
from segmentors.MobileSAMv2.ultralytics.yolo.engine.exporter import Exporter
from segmentors.MobileSAMv2.ultralytics.yolo.utils import (DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, NUM_THREADS, RANK, ROOT,
                                    callbacks, is_git_dir, yaml_load)
from segmentors.MobileSAMv2.ultralytics.yolo.utils.checks import check_file, check_imgsz, check_pip_update_available, check_yaml
from segmentors.MobileSAMv2.ultralytics.yolo.utils.downloads import GITHUB_ASSET_STEMS
from segmentors.MobileSAMv2.ultralytics.yolo.utils.torch_utils import smart_inference_mode
...
class YOLO:
    ...
    def __init__(self, model: Union[str, Path] = 'yolov8n.pt', task=None) -> None:
        ...
        if self.is_hub_model(model):
            from segmentors.MobileSAMv2.ultralytics.hub.session import HUBTrainingSession
