...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="./outputs/", help="image save path")
    parser.add_argument("--encoder_type", choices=['tiny_vit','sam_vit_h','mobile_sam','efficientvit_l2','efficientvit_l1','efficientvit_l0'],default='efficientvit_l2', help="choose the model type")
...
def main(args):
    ...
    for image_name in image_files:
        ...
        if obj_results is None:
            input_boxes1 = torch.tensor([[0, 0, 1, 1]], dtype=torch.float32).cuda()
        else:
