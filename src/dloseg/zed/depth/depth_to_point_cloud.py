...
from dloseg.zed.utils.utils import load_yaml  # Assumes load_yaml is defined here
...
def visualize_point_cloud_plt(points, sample=1):
    ...
    scatter = ax.scatter(
        points[:, 0], points[:, 1], points[:, 2], s=0.5, c=points[:, 2], cmap="viridis"
    )
...
if __name__ == "__main__":
    ...
    img_path = (
        "/home/admina/segmetation/DLOSeg/outputs/grounded_sam2_local_demo/groundingdino_mask_0.png"
    )
    # Load mask image
    ...
    np.save(
        "/home/admina/segmetation/DLOSeg/src/FoundationStereo/output/point_cloud.npy", point_cloud
    )
