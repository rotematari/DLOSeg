...
def print_camera_information(cam):
    ...
    print(
        f"ZED Camera Firmware       : {cam_info.camera_configuration.firmware_version}/{cam_info.sensors_configuration.firmware_version}"
    )
    print(
        f"ZED Camera Resolution     : {round(cam_info.camera_configuration.resolution.width, 2)}x{cam.get_camera_information().camera_configuration.resolution.height}"
    )
    print(f"ZED Camera FPS            : {int(cam_info.camera_configuration.fps)}")
